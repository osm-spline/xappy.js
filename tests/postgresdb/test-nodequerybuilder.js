...
module.exports = {
    'node': function(test) {
        ...
        var expected = {
            node : {
                name: '',
                text: 'SELECT ' + NODE_COLUMNS + ' FROM nodes, users WHERE nodes.user_id = users.id;',
                values: [],
                binary: true
            }
        };
    ...
    '//api/0.6/node[way]': function(test) {
        ...
        var expected = {
            node : {
                name: '',
                text: 'SELECT DISTINCT ' + NODE_COLUMNS + ' FROM nodes, way_nodes, users' +
    ...
    'node[tag]': function(test) {
        ...
        var expected = {
            node : {
                name: '',
                text: 'SELECT DISTINCT ' + NODE_COLUMNS + ' FROM nodes, users' +
