...
var log = log4js.getLogger('postgresdb/starQueryBuilder');
...
var createRelationSubQuery = function (xapiRequestObject) {
    ...
    */
    ...
    query.text = 'SELECT ' + columns + ' FROM' +
                    ' relations, users, relation_members, (' + query1 + ' UNION ' + query2 + ') AS relationIds' +
...
var createQueryPlan = function (xapiRequestObject) {
    ...
    log.debug('CREATE QUERYPLAN IN STARQB');
    var queryPlan = {
