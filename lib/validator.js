...
//            message : null
        ...
        if (xapiRequest.bbox &&
             ...
             error = errorModule.createError(400,'Bbox out of range. Please input values for left' +
...
*/
        ...
        if (xapiRequest.bbox &&
             ...
             error = errorModule.createError(400,'Bbox has swapped values. Please beware that left' +
        ...
        if (xapiRequest.tag &&
             ...
             error = errorModule.createError(204,'Request has a tag predicate and a' +
        ...
        if (xapiRequest.object === 'node' &&
            ...
            error = errorModule.createError(204,'Request object and child predicate attribute are both node');
            //log.warn('Warning: validating request returns an empty string', error);
            callback(error, null);
            return;
        }
        ...
        if (xapiRequest.object === 'way' &&
            ...
            error = errorModule.createError(204,'Request object and child predicate attribute are both way');
            //log.warn('Warning: validating request returns an empty string', error);
            callback(error, null);
            return;
        }
