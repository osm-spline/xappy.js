module.exports = {
    'validate' : function(xapiRequest,callback){
        ...
        if (xapiRequest.object === 'way' && xapiRequest.child !== undefined && xapiRequest.child.attribute === 'way'){
            error.code = 204;
            callback(error,null);
            return;
        }
        ...
        if (xapiRequest.object == 'way' && xapiRequest.child !== undefined && xapiRequest.child.attribute === 'node'){
            xapiRequestModified.object = xapiRequest.object;
            xapiRequestModified.bbox = xapiRequest.bbox;
            xapiRequestModified.tag = xapiRequest.tag;
            callback(null,xapiRequestModified);
